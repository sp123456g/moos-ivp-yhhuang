...
//Function list:
//1. mat STFT_WITH_FFTW3f(std::vector<double>, int fs)
//2. unsigned int frequency_mapping(unsigned int,int,int);
//3. double time_mapping(unsigned int,int,int);
//4. void detect_whistle(arma::mat &P,double threshold);
//5. void detect_click();
//-------------------------------------------------------------------------
...
//               x: input, need to be single channel data in std::vector<double> form
//              fs: sample rate
//               N: window length 
