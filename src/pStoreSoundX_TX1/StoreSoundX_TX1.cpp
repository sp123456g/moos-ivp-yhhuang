...
StoreSoundX_TX1::StoreSoundX_TX1()
{
  m_start_record = 0;
  m_start_check = 0;
  m_dir_flag = 1;
...
bool StoreSoundX_TX1::OnNewMail(MOOSMSG_LIST &NewMail)
{
...
bool StoreSoundX_TX1::OnConnectToServer()
{
   registerVariables();
   return(true);
}
...
bool StoreSoundX_TX1::OnStartUp()/*{{{*/
{
...
void StoreSoundX_TX1::registerVariables()
{
...
bool StoreSoundX_TX1::buildReport() 
{
  m_msgs << "============================================= \n";
...
string StoreSoundX_TX1::fileTime(char kind)/*{{{*/
{
  time_t timep;
  struct tm *p;
...
void StoreSoundX_TX1::setRecordParams(){/*{{{*/
  int rc;
